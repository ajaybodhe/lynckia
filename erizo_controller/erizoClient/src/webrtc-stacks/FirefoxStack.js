/*global window, console, mozRTCSessionDescription, RoapConnection, mozRTCPeerConnection*/

var Erizo = Erizo || {};

Erizo.FirefoxStableStack = function (spec) {
    "use strict";
    ...
    that.peerConnection = new MozRTCPeerConnection(that.pc_config);
    ...
    console.log("Created mozRTCPeerConnnection with config \"" + JSON.stringify(that.pc_config) + "\".");
